...
mgo::Log::Logger::Logger(const std::string& filename)
{
...
mgo::Log::Logger::~Logger()
{
    m_log.close();
}

//void mgo::Log::Logger::operator()(
void mgo::Log::Logger::Log(
...
mgo::Log::Logger* mgo::Log::g_logger{ nullptr };
